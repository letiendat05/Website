    ...
    <div class="neon-auth-container-wrapper">
        <div class="neon-auth-card">
            <div class="neon-auth-tabs">
                <button class="neon-auth-tab-button" onclick="window.location='<?php echo e(url('/dangnhap')); ?>'">Đăng nhập</button>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('dangky.css')); ?>">


    <script src="<?php echo e(asset('app.js')); ?>"></script>

<?php /**PATH C:\BTLweb\Website-main\resources\views/dangky.blade.php ENDPATH**/ ?>